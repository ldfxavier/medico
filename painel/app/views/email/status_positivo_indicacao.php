...
<table align="center" style="font-family: Arial, sans-serif" border="0" width="560px" bgcolor="#f4f4f4">
    ...
    <tr><td><img src="<?= LINK ?>/images/email/status_indicacao/bg.jpg" width="560px"></td></tr>

    <tr><td height="5"></td></tr>

    <tr><td style="line-height: 30px; background: #333; color: #FFF; font-size: 16px; padding: 15px; text-align: center;">
        PARABÉNS! A PARCERIA INDICADA FOI FORMALIZADA, ACESSE AGORA O SEU CLUBE E BUSQUE O SEU MAIS NOVO PARCERIO.
    </td></tr>
    ...
    <tr>
        ...
        Acesse o parceiro agora: https://<?= $_parceiro; ?>
        <table>
            <tr>
                <td></td>
            </tr>
